package PaperlessOffice::Mod::Classifier::BootStrap;
...
sub init {
  ...
  $self->_DocumentsDataLocation
    ($UNIVERSAL::systemdir."/data/classification/bootstrap/rival-categorizer/documents");

  my $conf = $UNIVERSAL::paperlessoffice->Config->CLIConfig;

  my $dir = "$UNIVERSAL::systemdir/data/classification/bootstrap/classes";
  $statepath = "$UNIVERSAL::systemdir/data/classification/bootstrap/model";
  ...
  if ($needstraining) {
	...
	(
	 name => $categoryname,
	 _CategoriesDataLocation => $UNIVERSAL::systemdir."/data/classification/bootstrap/rival-categorizer/categories",
	);
    ...
    my $k = new Rival::AI::Categorizer::KnowledgeSet
      (
       _KnowledgeSetDataLocation => $UNIVERSAL::systemdir."/data/classification/bootstrap/rival-categorizer/knowledge-set",
